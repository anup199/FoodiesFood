     ...
     <div class="main-content">
          <div class="wrapper">
               ...
               <?php
                    ...
                    if(isset($_GET['id']))
                    {
                         // Get the ordr Details
                         $id = $_GET['id'];

                         // Get all the order details based on this id
                    ...
                    <table class="tbl-30">
                         ...
                         <tr>
                              <td colspan="2">
                                   ...
                                   <input type="submit" name="submit" value="Update Order" class="">
               ...
               <?php
                         ...
                         // Check whethe clicked button is working or not
